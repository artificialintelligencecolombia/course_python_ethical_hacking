...
import subprocess
import optparse # This module allows the user to input arguments in the cli and parse them to be used whitin the code.

# Create instance for OptionParser class, which can handle user inputs used as arguments
